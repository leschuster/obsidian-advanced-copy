...
**Frontmatter variables**: Access any frontmatter field using a dollar sign followed by \`fm-\` and the name of the field. For example, if you have \`permalink: https://obsidian.md\` in your frontmatter, use \`$fm-permalink\` in your templates to insert that value. If the field doesn't exist, the variable is ignored.
